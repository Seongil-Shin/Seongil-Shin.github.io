...
[링크](https://seongil-shin.github.io/posts/babel/)
...
- 컨트롤러가 호출했을 때, 요청에 맞는 `비즈니스 로직`을 수행함. 응용프로그램에서 데이터를 처리하는 부분.
...
[링크](https://seongil-shin.github.io/posts/MVC-%ED%8C%A8%ED%84%B4/)
